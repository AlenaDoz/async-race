class WinnersPage {
  drawPage() {
    ...
    if (winnerList) {
      winnerList.append(this.drawWinner('red', 'Mersedes'));
      winnerList.append(this.drawWinner('blue', 'Tesla'));
      winnerList.append(this.drawWinner('black', 'Toyota'));
      winnerList.append(this.drawWinner('yellow', 'VW'));
      winnerList.append(this.drawWinner('green', 'Ford'));
    }
    document.body.append(winnerPage);
  }

  drawWinner(color: string, name = 'BMW') {
